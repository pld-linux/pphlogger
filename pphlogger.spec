...
PowerPhlogger to kompletne narzędzie do utrzymywania liczników.
Umożliwia oferowanie usługi licznika dla innych użytkowników serwisu.
Jest zbudowane w oparciu o PHP i wymaga serwera MySQL. Użytkownicy nie
potrzebują obsługi PHP na ich serwerze WWW - po prostu przekazują
